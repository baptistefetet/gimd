...
- **`src/index.js`** — entrypoint. Routing, OAuth (login/callback/logout), AES-256-GCM encryption of the
  session cookie, static file serving from `public/`.
...
- **`public/`** — vanilla-JS frontend (`index.html`, `app.js`, `style.css`), `manifest.json` +
